<div className="mt-[40vh] lg:mt-[10vh] animate-slideUp w-full flex flex-col items-center">
  <div className="w-full lg:w-3/4 lg:px-10">
    ...
    <div className="CardsContainer grid grid-cols-1 gap-4 mb-10
...
const Hardskills = () => {
  return (
    <div className="mt-[40vh] lg:mt-[10vh] animate-slideUp w-full flex justify-center items-center flex-col">
      ...
      lg:grid lg:grid-cols-4 lg:grid-rows-2 lg:gap-5 lg:p-10 lg:w-3/4 "
      >
        <div className="bg-[#ffffff]">
          <img src={reactIcon} alt="" className="w-full h-full" />
        </div>
